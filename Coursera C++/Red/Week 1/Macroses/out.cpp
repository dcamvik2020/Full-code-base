...
int main() {
  {
    ...
    tr.RunTest([] {
      ...
      output << (5) << endl << ("red belt") << endl;;
      { ostringstream os; os << "output.str()" << " != " << "\"5\\nred belt\\n\"" << ", " << "print_values.cpp" << ":" << 25; AssertEqual(output.str(), "5\nred belt\n", os.str()); };
...
void TestIfElse(){
  ...
  if (true)
    ...
    out << (3) << endl << (4) << endl;;
  { ostringstream os; os << "out.str()" << " != " << "\"1\\n2\\n\"" << ", " << "print_values.cpp" << ":" << 47; AssertEqual(out.str(), "1\n2\n", os.str()); }
}
...
void TestFor(){
  ...
  for (unsigned i = 0; i < 4; ++i) {
    if (i % 2 == 0)
      out << (i) << endl << ("even") << endl;;
    else
      out << (i) << endl << ("not even") << endl;;
  }

  string expected = "even\n";
  expected += "not even\n";
  expected += expected;
  { ostringstream os; os << "out.str()" << " != " << "expected" << ", " << "print_values.cpp" << ":" << 62; AssertEqual(out.str(), expected, os.str()); };
}
